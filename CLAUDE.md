...
**ステージ:** **1.2.0 が Google Play・App Store の両方で公開済み**(2026-08-27)。1.0.0 は 2026-08-23 公開。
**機能フリーズは解除済み** — 1.1 で「写真から記録」、1.2 で「写真から栽培登録」「進行帯」「成長記録」を出した。
...
**リリースの順序と履歴は docs/リリース手順.md §4b とタグ(`v1.0.0` / `v1.1.0` / `v1.2.0`)を正とする。**
