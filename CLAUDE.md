...
**ステージ:** **v0.5 Beta の機能まで完了**(WBS 1.1〜1.9・2.1〜2.8 / 2026-08-06)。
栽培 CRUD・場所・検索・作業ログ・ホームのタイムライン・収穫アルバム・カレンダー・
リマインダー・資材在庫・買い物リスト・バックアップ/復元が動く。次は v1.0(WBS 3.x)。

**次の最重量タスクは WBS 3.1(栽培暦 30 作物のマスターデータ)。** ここが v1.0 の律速。
