...
**ステージ:** **v0.5 Beta 完了 + v1.0 の一部が先行完了**
(WBS 1.1〜1.9・2.1〜2.9e・3.1〜3.4・3.6 / 2026-08-09)。
栽培 CRUD・場所・検索・作業ログ・タイムライン・収穫アルバム・カレンダー・
リマインダー・資材在庫・買い物リスト・バックアップ/復元(v2)・栽培暦(30 作物・出典明記)・
「今月の菜園仕事」・作物ガイド画面・「次の作業」・地域設定が動く。
だいどこ由来のテーブル・ネイティブは 2.9e で削除完了(下記参照)。

**次は v1.0 の残り(3.5 ホーム統合・3.7 AdMob 実 ID・3.8〜3.9 ストア公開)と
T1/T2(テスト整備)。** 実行計画(docs/WBS.md)の W5 で機能フリーズ。
