 ...
 *
 * ## カードの並び（WBS 3.5 で確定。2026-09-01: 実利用者の指摘で「育てているもの」を上げた）
 *
 ...
 * — 「ダッシュボードが見えない」という報告があった。そのため「育てているもの」を
    ...
    <View style={styles.root}>
      ...
      {!hasAnything ? (
        ...
        <ScrollView contentContainerStyle={styles.body}>
          ...
          {/* 育てているもの（自分の畑への入口）を「つぎの作業」より前に置く。
              「つぎの作業」は栽培ごとに複数行出て縦に伸びるため、後ろに置くと
              実機で画面外に落ち、実利用者が進行帯にたどり着けなかった
              （ファイル冒頭の doc コメント参照・2026-09-01） */}
          {growing.length > 0 ? (
